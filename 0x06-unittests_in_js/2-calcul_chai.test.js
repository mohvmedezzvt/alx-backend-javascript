...
describe('calculateNumber', function() {
  describe('SUM', function() {
    ...
    it('Has .5 or more', function() {
      assert.strictEqual(calculateNumber('SUM', 1, 3.7).to.equal(5));
    ...
    it('NaN', function() {
      expect(calculateNumber('SUM').toExponential.equal(NaN));
  ...
  describe('Error', function() {
    it('Error', function() {
      expect(calculateNumber('string', 1, 3).to.equal('Error'));
    });
  });
});
